...
public class Admin {
   ...
   /* private  ArrayList<Customer> Customer =  new ArrayList<>();
    ...
    public void g(){
        System.out.println("i dont give a shit");
    }
    ...
    public void ViewReports(){
         ...
         for(int i=0;i<d.size();i++){
          System.out.println( d.get(i).getReprotDescription());
    ...
    public void AddLibrarian(int Salary, int National_ID, String Username, String Password, String Email, int Age, int Phone_Number){
