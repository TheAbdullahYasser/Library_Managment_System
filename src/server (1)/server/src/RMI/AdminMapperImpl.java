...
public class AdminMapperImpl implements AdminMapper {
    ...
    @Override
    public void modifyLibrarian(String uname) {
        Scanner edit = new Scanner(System.in);
        System.out.println("Enter Which attribute needed to be modified");
        String editor = edit.nextLine();
        
        db.mongoCollection = db.mongoDatabase.getCollection("Librarian");
        ...
        switch(editor) {
            case "Salary":
                db.mongoCollection.updateOne(Filters.eq("Username", uname),
    ...
    public void deleteLibrarian(String uname) {
        db.mongoCollection = db.mongoDatabase.getCollection("Librarian");
        db.mongoCollection.deleteOne(Filters.eq("uname", uname));
